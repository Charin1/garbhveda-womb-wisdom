...
import { Shield, Activity, Heart, Mic, Smile, Wind, Clock, Users, Settings } from 'lucide-react';
                    ...
                    <div className="flex justify-between items-center text-slate-100">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center border border-slate-700 hover:bg-slate-700 transition-colors"
                                title="Settings"
                            >
                                <Settings size={16} />
                            </button>
